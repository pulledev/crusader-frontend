...
<DropdownMenu.Root>
    <DropdownMenu.Trigger
            class="border-input text-foreground  hover:bg-muted inline-flex h-10 w-10 select-none items-center justify-center rounded-full text-sm font-medium active:scale-[0.98]"
    >
